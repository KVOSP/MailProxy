...
<div class="container-fluid">
  <div class="row-fluid">
    ...
    <div class="span9">
      <form class="form-inline" action="historyquary" method="post">
      ...
      <div class="hero-unit">
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td style="vertical-align:middle;text-align:center">已发送</td>
            ...
            <td style="vertical-align:middle;text-align:center"><a href="../View/MailDetail.jsp?id=<%=mail.get("MailId") %>&isSend=Y">查看详情</a></td>
          </tr>
          <%
            }
          %>
